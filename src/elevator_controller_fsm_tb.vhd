...
begin
	...
	begin
        ...
        w_stop <= '1';  wait for k_clk_period;
            assert w_floor = x"3" report "bad wait on floor3 (1)" severity failure;
		--  go up again
		w_stop <= '0';  wait for k_clk_period;
            assert w_floor = x"4" report "bad up from floor3" severity failure;
		-- go back down one floor
		w_up_down <= '0';  wait for k_clk_period;
            assert w_floor = x"3" report "bad down from floor4 (1)" severity failure;
		-- go up the rest of the way
		w_up_down <= '1';  wait for k_clk_period;
            assert w_floor = x"4" report "bad down from floor3 (2)" severity failure;
		-- stop at top
		wait for k_clk_period;
            assert w_floor = x"4" report "bad stay at top" severity failure;
        -- go all the way down DOWN (how many clock cycles should that take?)
        w_up_down <= '0'; wait for k_clk_period;
            assert w_floor = x"3" report "bad down from floor4 (2)" severity failure;
        wait for k_clk_period;
        ...
        wait for k_clk_period;
            assert w_floor = x"1" report "bad stay at bottom" severity failure;
